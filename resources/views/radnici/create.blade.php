    ...
    <div class="ontainer mx-auto my-8 p-6 bg-white rounded-lg shadow-lg w-full sm:w-4/5 lg:w-1/2">
        ...
        <form action="{{ route('radnici.store') }}" method="POST">
            ...
            <div class="form-group">
                <label for="ime" class="form-label block text-gray-700 text-sm font-bold mb-1 mt-4">Ime:</label>
            ...
            <div class="form-group">
                <label for="prezime" class="form-label block text-gray-700 text-sm font-bold mb-1 mt-4">Prezime:</label>
            ...
            <div class="form-group">
                <label for="pozicija" class="form-label block text-gray-700 text-sm font-bold mb-1 mt-4">Pozicija:</label>
                <input type="text" name="pozicija"
                    class="form-control shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    placeholder="Unesite poziciju radnika" value="{{ old('pozicija') }}" required>
            </div>
            <div class="form-group">
                <label for="plata" class="form-label block text-gray-700 text-sm font-bold mb-1 mt-4">Plata:</label>
