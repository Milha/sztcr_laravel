<x-layout>
    <x-slot:meta>
        <title>Edit {{ $korisnik->ime }} | SZTR</title>
        <meta name="description" content="Izmena informacija o korisniku {{ $korisnik->ime }} koji sarađuje sa SZTR.">
        <meta name="keywords" content="korisnik, SZTR, saradnja, nabavka">
